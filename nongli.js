...
var Lunar = {
  ...
  lunarMonths: function (year) {
    ...
    console.log('year - this.MIN_YEAR', year - this.MIN_YEAR)
  ...
  lunarByBetween: function (year, between) {
    ...
    if (between == 0) {
      ...
      console.log('this.lunarYearDays(year)', this.lunarYearDays(year))
  ...
  toLunar: function (year, month, day) {
    ...
    let aaa = this.betweenSolarDays(year, month, day, yearData[1], yearData[2])
    console.log(aaa)
    return this.lunarByBetween(year, aaa)
  },
  //转换公历
  //@param year  阴历-年
...
console.log(Lunar.toLunar(2023, 4, 26))

// let lunarUtil = require('./js/lunar')
...
// console.log('getDiffDay', getDiffDay('2050-12-31', '2000-1-1'))

// let startDate = new Date('2000-01-01')
// let ganzhiList = []
// for (let index = 0; index < getDiffDay('2050-12-31', '2000-1-1'); index++) {
//   startDate.setDate(startDate.getDate() + 1)
//   console.log(startDate)
//   var baziLunar = lunarUtil.Solar.fromDate(startDate).getLunar()
//   ganzhiList.push(baziLunar.getYearInGanZhiByLiChun() + baziLunar.getMonthInGanZhi() + baziLunar.getDayInGanZhi())
// }
// console.log(ganzhiList)
